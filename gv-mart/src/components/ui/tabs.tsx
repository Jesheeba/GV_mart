...
const tabsListVariants = cva(
  "group/tabs-list inline-flex w-fit items-center justify-center rounded-full bg-surface-alt p-1 text-text-muted group-data-horizontal/tabs:h-10 group-data-vertical/tabs:h-fit group-data-vertical/tabs:flex-col data-[variant=line]:rounded-none",
  {
    variants: {
      variant: {
        default: "bg-muted",
  ...
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        ...
        // `data-active:text-primary-foreground` and could win, rendering near-black text
        // on the active-pill background (invisible label on hover/after-click).
