...
create or replace function public._audit_check_execute_grants()
...
revoke execute on function public._audit_check_execute_grants() from public, anon, authenticated;
grant execute on function public._audit_check_execute_grants() to service_role;
