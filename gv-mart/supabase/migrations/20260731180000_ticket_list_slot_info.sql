-- Customer Dashboard Booking Audit (2026-07-31) Task 3/5: the bookings LIST
-- page must reflect slot name/live times too, not just the detail page —
-- redefines list_my_tickets_filtered (20260730120000_customer_ticket_
-- filters.sql) with the appointment sub-object extended. Signature is
-- unchanged (compatible create-or-replace); everything else in the function
-- body is verbatim from the live version.
